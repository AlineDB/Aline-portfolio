...
<main class="layout">
    ...
    <section class="layout__skills skills">
        ...
        <button class="softskill__button"><a href="<?php echo get_template_directory_uri().'/img/DE%20BARROS%20A.cv.pdf'; ?>" title="Télécharger le Cv au format PDF"><?= __('Télécharger le CV d\'Aline', 'Aline-db-portfolio'); ?></a></button>
    </section>
</main>
