...
<main class="layout">
    <section class="layout__about about">
        <h2 class="about__title"><?= __('Qui est Aline ?', 'Aline-db-portfolio'); ?></h2>
        <div class="about__container">
            <p class="about__description">
                <?= __('Jeune femme mariée et mère de famille, je souhaite dorénavant me consacrer à ma carrière.
            J\'ai pu exercer en tant que commis de cuisine, employée callcenter, caissière et employée administrative. Aujourd\'hui, je souhaite
                me spécialiser dans le webdesign tout en proposant mes diverses compétences pour compléter mon savoir-faire.', 'Aline-db-portfolio'); ?>
            </p>
    ...
    <section class="layout__projects projects">
        <h2 class="projects__title"><?= __('Mes derniers projets web et design', 'Aline-db-portfolio'); ?></h2>
        <div class="projects__container">
            ...
            <?php endwhile; else: ?>
                <p class="projects__empty"><?= __('Il n\'y a pas de projet à vous montrer ...', 'Aline-db-portfolio'); ?></p>
            <?php endif; ?>
        </div>
    </section>

    <section class="layout__others others">
        <h2 class="projects__title"><?= __('Webdesign mais aussi', 'Aline-db-portfolio'); ?></h2>
        <div class="projects__container">
    ...
    <section class="layout__skills skills">
        <h2 class="skills__title"><?= __('Quelles sont les compétences d\'Aline', 'Aline-db-portfolio'); ?></h2>
        <div class="skills__container langages">
            <h3 class="skills__subtitle"><?= __('Languages', 'Aline-db-portfolio'); ?></h3>
            <ul class="skills__langages">
                ...
                <li class="skills__li">Typescript</li>
            </ul>
        </div>
        <div class="skills__container programs">
            <h3 class="skills__subtitle"><?= __('Logiciels', 'Aline-db-portfolio'); ?></h3>
        ...
        <div class="skills__container softskills">
            <h3 class="skills__subtitle">Softskills</h3>
            <ul class="skills__softskills">
                <li class="skills__li"><?= __('Organisée', 'Aline-db-portfolio'); ?></li>
                <li>
                ...
                <li class="skills__li"><?= __('Bonne humeur', 'Aline-db-portfolio'); ?></li>
                <li>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#FFD700" class="bi bi-star" viewBox="0 0 16 16">
                        <path d="M2.866 14.85c-.078.444.36.791.746.593l4.39-2.256 4.389 2.256c.386.198.824-.149.746-.592l-.83-4.73 3.522-3.356c.33-.314.16-.888-.282-.95l-4.898-.696L8.465.792a.513.513 0 0 0-.927 0L5.354 5.12l-4.898.696c-.441.062-.612.636-.283.95l3.523 3.356-.83 4.73zm4.905-2.767-3.686 1.894.694-3.957a.565.565 0 0 0-.163-.505L1.71 6.745l4.052-.576a.525.525 0 0 0 .393-.288L8 2.223l1.847 3.658a.525.525 0 0 0 .393.288l4.052.575-2.906 2.77a.565.565 0 0 0-.163.506l.694 3.957-3.686-1.894a.503.503 0 0 0-.461 0z"/>
                    </svg>
                ...
                <li class="skills__li"><?= __('Investie', 'Aline-db-portfolio'); ?></li>
                <li>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#FFD700" class="bi bi-star" viewBox="0 0 16 16">
                        <path d="M2.866 14.85c-.078.444.36.791.746.593l4.39-2.256 4.389 2.256c.386.198.824-.149.746-.592l-.83-4.73 3.522-3.356c.33-.314.16-.888-.282-.95l-4.898-.696L8.465.792a.513.513 0 0 0-.927 0L5.354 5.12l-4.898.696c-.441.062-.612.636-.283.95l3.523 3.356-.83 4.73zm4.905-2.767-3.686 1.894.694-3.957a.565.565 0 0 0-.163-.505L1.71 6.745l4.052-.576a.525.525 0 0 0 .393-.288L8 2.223l1.847 3.658a.525.525 0 0 0 .393.288l4.052.575-2.906 2.77a.565.565 0 0 0-.163.506l.694 3.957-3.686-1.894a.503.503 0 0 0-.461 0z"/>
                    </svg>
                ...
                <li class="skills__li"><?= __('Télétravail possible', 'Aline-db-portfolio'); ?></li>
                <li>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#FFD700" class="bi bi-star" viewBox="0 0 16 16">
                        <path d="M2.866 14.85c-.078.444.36.791.746.593l4.39-2.256 4.389 2.256c.386.198.824-.149.746-.592l-.83-4.73 3.522-3.356c.33-.314.16-.888-.282-.95l-4.898-.696L8.465.792a.513.513 0 0 0-.927 0L5.354 5.12l-4.898.696c-.441.062-.612.636-.283.95l3.523 3.356-.83 4.73zm4.905-2.767-3.686 1.894.694-3.957a.565.565 0 0 0-.163-.505L1.71 6.745l4.052-.576a.525.525 0 0 0 .393-.288L8 2.223l1.847 3.658a.525.525 0 0 0 .393.288l4.052.575-2.906 2.77a.565.565 0 0 0-.163.506l.694 3.957-3.686-1.894a.503.503 0 0 0-.461 0z"/>
                    </svg>
                ...
                <li class="skills__li"><?= __('Capacité d\'adaptation', 'Aline-db-portfolio'); ?></li>
                <li>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#FFD700" class="bi bi-star" viewBox="0 0 16 16">
                        <path d="M2.866 14.85c-.078.444.36.791.746.593l4.39-2.256 4.389 2.256c.386.198.824-.149.746-.592l-.83-4.73 3.522-3.356c.33-.314.16-.888-.282-.95l-4.898-.696L8.465.792a.513.513 0 0 0-.927 0L5.354 5.12l-4.898.696c-.441.062-.612.636-.283.95l3.523 3.356-.83 4.73zm4.905-2.767-3.686 1.894.694-3.957a.565.565 0 0 0-.163-.505L1.71 6.745l4.052-.576a.525.525 0 0 0 .393-.288L8 2.223l1.847 3.658a.525.525 0 0 0 .393.288l4.052.575-2.906 2.77a.565.565 0 0 0-.163.506l.694 3.957-3.686-1.894a.503.503 0 0 0-.461 0z"/>
                    </svg>
                ...
                <li class="skills__li"><?= __('Communication aisée', 'Aline-db-portfolio'); ?></li>
                <li>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#FFD700" class="bi bi-star" viewBox="0 0 16 16">
                        <path d="M2.866 14.85c-.078.444.36.791.746.593l4.39-2.256 4.389 2.256c.386.198.824-.149.746-.592l-.83-4.73 3.522-3.356c.33-.314.16-.888-.282-.95l-4.898-.696L8.465.792a.513.513 0 0 0-.927 0L5.354 5.12l-4.898.696c-.441.062-.612.636-.283.95l3.523 3.356-.83 4.73zm4.905-2.767-3.686 1.894.694-3.957a.565.565 0 0 0-.163-.505L1.71 6.745l4.052-.576a.525.525 0 0 0 .393-.288L8 2.223l1.847 3.658a.525.525 0 0 0 .393.288l4.052.575-2.906 2.77a.565.565 0 0 0-.163.506l.694 3.957-3.686-1.894a.503.503 0 0 0-.461 0z"/>
                    </svg>
                ...
                <li class="skills__li"><?= __('N\'hésite pas à se former', 'Aline-db-portfolio'); ?></li>
                <li>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#FFD700" class="bi bi-star" viewBox="0 0 16 16">
                        <path d="M2.866 14.85c-.078.444.36.791.746.593l4.39-2.256 4.389 2.256c.386.198.824-.149.746-.592l-.83-4.73 3.522-3.356c.33-.314.16-.888-.282-.95l-4.898-.696L8.465.792a.513.513 0 0 0-.927 0L5.354 5.12l-4.898.696c-.441.062-.612.636-.283.95l3.523 3.356-.83 4.73zm4.905-2.767-3.686 1.894.694-3.957a.565.565 0 0 0-.163-.505L1.71 6.745l4.052-.576a.525.525 0 0 0 .393-.288L8 2.223l1.847 3.658a.525.525 0 0 0 .393.288l4.052.575-2.906 2.77a.565.565 0 0 0-.163.506l.694 3.957-3.686-1.894a.503.503 0 0 0-.461 0z"/>
                    </svg>
        ...
        <button class="softskill__button"><a href="<?php echo get_template_directory_uri().'/img/DE%20BARROS%20A.cv.docx'; ?>" title="Télécharger le Cv au format docx"><?= __('Télécharger le CV d\'Aline', 'Aline-db-portfolio'); ?></a></button>
    </section>
</main>
