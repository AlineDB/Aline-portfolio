...
<main class="layout">
    ...
    <section class="layout__projects projects">
        <h2 class="projects__title">Mes derniers voyages</h2>
                ...
                <article class="project">
                    ...
                    <div class="project__card">
                        <header class="project__head">
                            ...
                            <p class="project__date"><time class="project__time" datetime="<?= date('c', strtotime(get_field('departure_date', false, false))); ?>">
